...
struct library
{
    ...
    char book_name[100];
    //to stor the name of the author of the book
    char author_name[100];
    //to store tha cost of the book
    float cost;
...
int main()
{
    //using the stuct library to perform operation
    ...
    while(j!=6)
    {
        ...
        switch(j)
        {
            //in order to add book details
            case 1:
            printf("\nYou can add the details if the book");
            printf("\nEnter the book name:");
            ...
            case 3:
            //to view the total number of the books
